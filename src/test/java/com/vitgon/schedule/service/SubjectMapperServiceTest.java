...
public class SubjectMapperServiceTest {
	...
	public void init() {
		...
		subjectMapperService = spy(new SubjectMapperService(subjectService, subjectTranslService));
	}
	...
	public void testMapToMap() {
		...
		Map<Integer, String> resultMap = subjectMapperService.mapToMap(locale, substituteNull);
