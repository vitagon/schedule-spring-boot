INSERT INTO major (id, name, url, duration, school_id, degree) VALUES (15, 'economics security', 'economics_security', 5, 12, 2);
INSERT INTO major_translations (major_id, locale_id, title) VALUES (15, 2, 'экономическая безопасность');

INSERT INTO major (id, name, url, duration, school_id, degree) VALUES (16, 'management', 'management', 4, 12, 1);
