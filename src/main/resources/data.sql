...
INSERT INTO users (id, email, password, key_lastname, key_firstname, key_middlename, active) VALUES (1, 'admin@gmail.com', '$2a$10$D5R2BLeMpFJ0GSCVQejLVetF0273XekBLOoPlSWNargBuRe/rinYm', 'Goncharov', 'Vitaliy', 'Dmitrievich', 1)
INSERT INTO user_role (user_id, role_id) VALUES (1, 1), (1, 3)

/* email: user@gmail.com password: 123123 ROLES: [USER] */
INSERT INTO users (id, email, password, key_lastname, key_firstname, active) VALUES (2, 'user@gmail.com', '$2a$10$D5R2BLeMpFJ0GSCVQejLVetF0273XekBLOoPlSWNargBuRe/rinYm', 'Kerrenson', 'David', 1)
...
INSERT INTO users (id, email, password, key_lastname, key_firstname, key_middlename, active) VALUES (3, 'efremova.pv@dvfu.ru', '$2a$10$D5R2BLeMpFJ0GSCVQejLVetF0273XekBLOoPlSWNargBuRe/rinYm', 'efremova','polina','vitalyevna', 1)
INSERT INTO users (id, email, password, key_lastname, key_firstname, key_middlename, active) VALUES (4, 'vorobeva.lg@dvfu.ru', '$2a$10$D5R2BLeMpFJ0GSCVQejLVetF0273XekBLOoPlSWNargBuRe/rinYm', 'vorobyeva','larisa','gennadyevna', 1)
INSERT INTO users (id, email, password, key_lastname, key_firstname, key_middlename, active) VALUES (5, 'mishunina.ln@dvfu.ru', '$2a$10$D5R2BLeMpFJ0GSCVQejLVetF0273XekBLOoPlSWNargBuRe/rinYm', 'mishunina','lidia','nikolaevna', 1)
INSERT INTO users (id, email, password, key_lastname, key_firstname, key_middlename, active) VALUES (6, 'karpets.ov@dvfu.ru', '$2a$10$D5R2BLeMpFJ0GSCVQejLVetF0273XekBLOoPlSWNargBuRe/rinYm', 'karpets','olga','viktorovna', 1)
